...
namespace NextwoFinalApp.Areas.Administrator.Controllers
{
    ...
    public class SettingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SettingId,Phone,Phone2,Mobile,Email,FB,LinkedIn,AboutUs,Fax,Img,CreationDate,IsPublished,IsDeleted,UserId")] Setting setting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SettingId,Phone,Phone2,Mobile,Email,FB,LinkedIn,AboutUs,Fax,Img,CreationDate,IsPublished,IsDeleted,UserId")] Setting setting)
        {
