...
namespace NextwoFinalApp.Areas.Administrator.Controllers
{
    ...
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClientId,ClientName,ClientPosition,Image,CreationDate,IsPublished,IsDeleted,UserId")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClientId,ClientName,ClientPosition,Image,CreationDate,IsPublished,IsDeleted,UserId")] Client client)
        {
